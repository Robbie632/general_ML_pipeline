...
def split_data(data, known_identifier_col, known_identifier_value):
    ...
    Paramaters:
        ...
        known_identifier_value :string/int, value in known_identifier_column 
        that encodes target as known
    ...
    my_data_known = data[data[known_identifier_col] == known_identifier_value]
    my_data_unknown = data[data[known_identifier_col] != known_identifier_value]
